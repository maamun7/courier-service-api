...
@section('title') Change admin user password @stop
...
@section ('breadcrumbs')
    ...
    <li class="active"> {!! link_to_route('admin.change_password', 'Change password') !!} </li>
@stop
...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        {!! Form::open(['route' => 'admin.change_password', 'role' => 'form', 'method' => 'post', 'id' => "change_password"]) !!}

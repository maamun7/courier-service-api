            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        <a href="{!! route('admin.agent.new') !!}" class="btn btn-sm btn-brand m-btn--pill">
                            <span class="la la-plus"></span>&nbsp; New Rider
                        </a>
                    </h3>                 
                </div> 
            </div>
        ...
        <div class="m-portlet__body">
            <div class="m-section">
                <div class="m-section__content table-responsive">
                    <table id="agent-datatable" class="table table-sm m-table m-table--head-bg-brand table-responsive table-striped table-hover custom_table_responsive">
                        <thead class="">
                            <tr>
                                <th>Sl.</th>
                                <th>Name</th>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var table = $('#agent-datatable').DataTable({
                ...
                ajax: {
                    url: '{!! route('admin.datatable.agent') !!}',
                    type: 'GET',
                    data: function( d ) {
                        d._token = "{{ csrf_token() }}";
                    }
            ...
            $('#agent-datatable_length').addClass('col-lg-6 col-md-6 col-sm-6');
            $('#agent-datatable_length .form-control').addClass('m-bootstrap-select m-bootstrap-select--air filter-select');
            $('#date-filter').addClass('col-lg-3 col-md-3 col-sm-3');
            $('#agent-datatable_filter').addClass('col-lg-3 col-md-3 col-sm-3');
            ...
            $('#agent-datatable_filter label:first-child input').attr('placeholder', 'Name, mobile, email');

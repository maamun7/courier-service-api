...
@section('content')
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        <a href="{!! route('admin.category.new') !!}" class="btn btn-sm btn-brand m-btn--pill">
        ...
        <div class="m-portlet__body">
            <div class="m-section">
                <div class="m-section__content">
                    <table id="categorys-datatable" class="table table-sm m-table m-table--head-bg-brand table-responsive table-striped table-hover custom_table_responsive">
                        <thead class="">
                        <tr>
                            <th>Sl.</th>
                            <th>Name</th>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var table = $('#categorys-datatable').DataTable({
                processing: true,
                serverSide: true,
                paging: true,
                pageLength: 25,
            ...
            $('#categorys-datatable_length').addClass('col-lg-6 col-md-6 col-sm-6');
            $('#categorys-datatable_length .form-control').addClass('m-bootstrap-select m-bootstrap-select--air filter-select');
            $('#date-filter').addClass('col-lg-3 col-md-3 col-sm-3');
            $('#categorys-datatable_filter').addClass('col-lg-3 col-md-3 col-sm-3');
            ...
            $('#categorys-datatable_filter label:first-child input').attr('placeholder', 'Name, mobile, email');
    ...
    <script type="text/javascript">
        ...
        $(document).on('click','.export-file',function(e)
        {
            ...
            $.ajax({
                type: "POST",
                url: "{!! route('admin.categorys.export') !!}",

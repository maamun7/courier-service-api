...
@section('title') Create New Courier Zone @stop


@section('page_name')
    Courier Zone Management
    <small>New Courier Zone</small>
@stop
...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        {!! Form::open(['route' => 'admin.courier_zone.store', 'role' => 'form', 'method' => 'post', 'id' => "add-Courier Zone"]) !!}
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-2">
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('zone_name') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('zone_name', null, ['class' => 'form-control m-input','id'=>'zone_name','value'=>Input::old('zone_name'), 'placeholder' => 'Enter Courier Zone Name', 'tabindex' => '1']) !!}

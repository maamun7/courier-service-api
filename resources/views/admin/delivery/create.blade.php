                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4 {!! $errors->has('recipient_address') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::text('recipient_address', null, ['class' => 'form-control m-input','id'=>'recipient_email','value'=>Input::old('recipient_email'), 'placeholder' => 'Enter recipient address !', 'tabindex' => '3']) !!}
                        ...
                        <div class="col-md-4 {!! $errors->has('recipient_zone') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                <label>Recipient Zone <span class="text-danger">*</span></label>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4 {!! $errors->has('hub_id') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="hub_id" tabindex="5">
...
{{--                                {!! Form::select('recipient_zone', $zone, null, array('class' => 'form-control m-input','id'=>'selectZone','value'=>Input::old('recipient_zone'), 'placeholder' => 'Select recipient zone !', 'tabindex' => '4')) !!}--}}
                        ...
                        <div class="col-md-4 {!! $errors->has('g_map_recipient_address') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                <label>Google Map Verified Address <span class="text-danger">*</span></label>
                                {!! Form::text('g_map_recipient_address', null, ['class' => 'form-control m-input','id'=>'recipient_address', 'rows' => "6", 'value'=>Input::old('recipient_address'), 'placeholder' => 'Enter recipient address !', 'tabindex' => '6']) !!}
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-2 {!! $errors->has('merchant') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::select('merchant', $merchant, null, array('class' => 'form-control m-input selectMerchant','id'=>'selectMerchant','value'=>Input::old('merchant'), 'placeholder' => 'Select merchant!', 'tabindex' => '7')) !!}
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4 {!! $errors->has('plan') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::select('plan', $plan, null, array('class' => 'form-control m-input','id'=>'selectPlan', 'value'=>Input::old('plan'), 'placeholder' => 'select plan !', 'tabindex' => '9')) !!}
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4 {!! $errors->has('delivery_date') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                <div class='input-group date' id='m_datetimepicker_5'>
                                    {!! Form::text('delivery_date', null, ['class' => 'form-control m-input','id'=>'delivery_date','value'=>Input::old('delivery_date'), 'placeholder' => 'Enter delivery date', 'tabindex' => '10']) !!}
                        ...
                        <div class="col-md-4 {!! $errors->has('merchant_order_id') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::text('merchant_order_id', null, ['class' => 'form-control m-input','id'=>'merchant_order_id','value'=>Input::old('merchant_order_id'), 'placeholder' => 'Enter Merchant Order ID', 'tabindex' => '11']) !!}
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 {!! $errors->has('special_instruction') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('special_instruction', null, ['class' => 'form-control m-input','id'=>'special_instruction', 'rows' => "6", 'value'=>Input::old('special_instruction'), 'placeholder' => 'Enter instruction !', 'tabindex' => '12']) !!}
        ...
        <div class="m-portlet__foot clearfix">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-offser-2 col-md-offset-2 col-sm-offset-2">
                    <div class="pull-left">
                        <button class="btn btn-default" tabindex="13" name="save" value="form_submit">
                            <i class="fa fa-check-circle text-success fa-lg" aria-hidden="true"></i>
                            <span class="text-success"> Save </span>
                        </button>
                        <button class="btn btn-default" tabindex="14" name="save" value="form_submit_n_print">
                            <i class="fa fa-print text-success fa-lg" aria-hidden="true"></i>
                            <span class="text-success"> Save & Print </span>
                        </button>
                        &nbsp;
                        <span class="btn btn-default reset-form" tabindex="15">
                            <i class="fa fa-history text-info fa-lg" aria-hidden="true"></i>
                            <span class="text-success"> Reset </span>
                        </span>
                        &nbsp;
                        <a href="{!! route('admin.deliverys') !!}" class="btn btn-default" tabindex="16">

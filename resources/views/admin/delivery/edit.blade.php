                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4 {!! $errors->has('recipient_address') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::text('recipient_address', $delivery->recipient_address, ['class' => 'form-control m-input','id'=>'recipient_email','value'=>Input::old('recipient_email'), 'placeholder' => 'Enter recipient address !', 'tabindex' => '3']) !!}
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-2 {!! $errors->has('merchant') ? 'has-error' : 'merchant'  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::select('merchant', $merchant, $delivery->merchant_id, array('class' => 'form-control m-input selectMerchant','id'=>'selectMerchant','value'=>Input::old('merchant'), 'placeholder' => 'Select merchant!', 'tabindex' => '7')) !!}
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4 {!! $errors->has('plan') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="plan" id="selectPlan" tabindex="9">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4 {!! $errors->has('delivery_date') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                <div class='input-group date' id='m_datetimepicker_5'>
                                    {!! Form::text('delivery_date', $delivery->delivery_date, ['class' => 'form-control m-input','id'=>'delivery_date','value'=>Input::old('delivery_date'), 'placeholder' => 'Enter delivery date', 'tabindex' => '10']) !!}
                        ...
                        <div class="col-md-4 {!! $errors->has('merchant_order_id') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::text('merchant_order_id', $delivery->merchant_order_id, ['class' => 'form-control m-input','id'=>'merchant_order_id','value'=>Input::old('merchant_order_id'), 'placeholder' => 'Enter Merchant Order ID', 'tabindex' => '11']) !!}
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 {!! $errors->has('special_instruction') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('special_instruction', $delivery->special_instruction, ['class' => 'form-control m-input','id'=>'special_instruction', 'rows' => "6", 'value'=>Input::old('special_instruction'), 'placeholder' => 'Enter instruction !', 'tabindex' => '12']) !!}
        ...
        <div class="m-portlet__foot clearfix">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-offser-2 col-md-offset-2 col-sm-offset-2">
                    <div class="pull-left">
                        <button class="btn btn-default" tabindex="13">
                            <i class="fa fa-check-circle text-success fa-lg" aria-hidden="true"></i>
                            <span class="text-success"> Save </span>
                        </button>
                        &nbsp;
                        <span class="btn btn-default reset-form" tabindex="14">
                            <i class="fa fa-history text-info fa-lg" aria-hidden="true"></i>
                            <span class="text-success"> Reset </span>
                        </span>
                        &nbsp;
                        <a href="{!! route('admin.deliverys') !!}" class="btn btn-default" tabindex="15">
                            <i class="fa fa-remove text-danger fa-lg" aria-hidden="true"></i>&nbsp; <span class="text-danger"> Cancel </span>
                        </a>
                    </div>
                    <div class="pull-right">
                        <button class="btn btn-default" type="button" onclick="approveDelivery({{$delivery->id}})" tabindex="16">
                            <i class="fa fa-check-circle text-success fa-lg" aria-hidden="true"></i>

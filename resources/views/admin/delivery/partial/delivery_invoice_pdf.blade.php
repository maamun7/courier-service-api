...
{{--                                                {{$delivery->merchant->address}}<br>--}}
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                ...
                                                @endif
                                                <br>
                                                <b>Total Receivable: </b><span style="font-weight: bold">{{$delivery->amount_to_be_collected}} Tk</span>
                                            </div>
                                        </div>
{{--                                        <div class="row mt-3">--}}
{{--                                            <div class="col-md-12">--}}
...
{{--                                        </div>--}}
                                        <div class="row mt-1">
                                            <div class="col-md-12">
                                                <?php
                                                    echo '<img src="data:image/png;base64,' . Milon\Barcode\DNS1D::getBarcodePNG("PARCELBD-".$delivery->consignment_id, "C93",1,50) . '" alt="barcode"   />';
                                                ?>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-8">
                                                <span class="font-weight-bold" style="padding-left: 55px;"><b>{{$delivery->consignment_id}}</b></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>

...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        {!! Form::open(['route' => ['admin.expense.update', $expense->id], 'role' => 'form', 'method' => 'post', 'id' => "add-expense", "files" => true]) !!}
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-2">
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('exp_category_id') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::select('exp_category_id',$cat_list, $expense->exp_category_id, ['class' => 'form-control m-input m-bootstrap-select m_m_selectpicker1','id'=>'exp_category_id', 'placeholder' => 'Select Category', 'tabindex' => '1']) !!}
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('amount') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('amount', $expense->amount, ['class' => 'form-control m-input','id'=>'amount','value'=>Input::old('amount'), 'placeholder' => 'Enter Amount', 'tabindex' => '2']) !!}
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('expense_date') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('expense_date', $expense->expense_date, ['class' => 'form-control m-input ','id'=>'expense_date', 'placeholder' => 'Select Date', 'tabindex' => '1']) !!}
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('payment_type') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::Select('payment_type',["cash" => "Cash", "bKash" => "bKash", "cheque" => "Cheque"],$expense->payment_type, ['class' => 'form-control m-input','id'=>'payment_type','value'=>Input::old('payment_type'), 'placeholder' => 'Select Payment Type', 'tabindex' => '2']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 {!! $errors->has('description') ? 'has-error' : '' !!}">
                                <label>Description</label>
                                {!! Form::textArea('description', $expense->description, ['class' => 'form-control m-input','id'=>'description','value'=>Input::old('amount'), 'placeholder' => 'Enter Amount', 'tabindex' => '3']) !!}

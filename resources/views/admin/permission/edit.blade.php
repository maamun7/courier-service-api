...
@section('content')
    ...
    <div class="m-portlet m-portlet--tab">
        <!--begin::Form-->
        {!! Form::open(['route' => ['admin.permission.update',$permission->id], 'role' => 'form', 'method' => 'post', 'class'=>'m-form m-form--fit m-form--label-align-right', 'id' => "edit-permission"]) !!}
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <div class="form-group m-form__group {{{ $errors->has('permission_slug') ? 'has-error' : '' }}}">
                            ...
                            {!! Form::text('permission_slug',$permission->name, ['class' => 'form-control m-input','id'=>'permission_slug','value'=>Input::old('permission_slug'), 'placeholder' => 'Enter Permission Slug']) !!}
                        ...
                        <div class="form-group m-form__group {{{ $errors->has('display_name') ? 'has-error' : '' }}}">
                            ...
                            {!! Form::text('display_name',$permission->display_name, ['class' => 'form-control m-input','id'=>'fast_name','value'=>Input::old('display_name'), 'placeholder' => 'Enter Display Name']) !!}
                        ...
                        <div class="form-group m-form__group {{{ $errors->has('permission_group') ? 'has-error' : '' }}}">
                            ...
                            {!! Form::select('permission_group', $groups, $permission->permission_group_id, array('class' => 'form-control m-input', 'id' => 'permission', 'value'=>Input::old('permission_group'))) !!}
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(".reset-form").click(function() {
                $(':input','#edit-permission').not(':button, :submit, :reset, :hidden').val('').removeAttr('checked').removeAttr('selected');
            })
        });
    </script>
@stop
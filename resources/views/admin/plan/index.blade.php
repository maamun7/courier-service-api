...
@section('content')
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        <a href="{!! route('admin.plan.new') !!}" class="btn btn-sm btn-brand m-btn--pill">
                            <span class="la la-plus"></span>&nbsp; New Plan
                        </a>
                    </h3>
                </div>
            </div>
        ...
        <div class="m-portlet__body">
            <div class="m-section">
                <div class="m-section__content">
                    <table id="plan-datatable" class="table table-sm m-table m-table--head-bg-brand table-responsive table-striped table-hover custom_table_responsive">
                        <thead class="">
                        <tr>
                            <th>Sl.</th>
                            <th>Unique Code</th>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var table = $('#plan-datatable').DataTable({
                processing: true,
                serverSide: true,
                paging: true,
                pageLength: 25,
                ...
                ajax: {
                    url: '{!! route('admin.datatable.plan') !!}',
                    type: 'GET',
                    data: function( d ) {
                        d._token = "{{ csrf_token() }}";
                    }
            ...
            $('#plan-datatable_length').addClass('col-lg-6 col-md-6 col-sm-6');
            $('#plan-datatable_length .form-control').addClass('m-bootstrap-select m-bootstrap-select--air filter-select');
            $('#date-filter').addClass('col-lg-3 col-md-3 col-sm-3');
            $('#plan-datatable_filter').addClass('col-lg-3 col-md-3 col-sm-3');
            ...
            $('#plan-datatable_filter label:first-child input').attr('placeholder', 'Name, mobile, email');

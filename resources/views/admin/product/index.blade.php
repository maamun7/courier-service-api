...
@section ('breadcrumbs')
    ...
    <li class="active"> {!! link_to_route('admin.products', ' Product Management') !!} </li>
@stop
        ...
        <div class="m-portlet__body">
            <div class="m-section">
                <div class="m-section__content">
                    <table id="products-datatable" class="table table-sm m-table m-table--head-bg-brand table-responsive table-striped table-hover custom_table_responsive">
                        <thead class="">
                        <tr>
                            <th>Sl.</th>
                            <th>Product Name</th>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var table = $('#products-datatable').DataTable({
                ...
                ajax: {
                    url: '{!! route('admin.datatable.product') !!}',
                    type: 'GET',
                    data: function( d ) {
                        d._token = "{{ csrf_token() }}";
                    }
            ...
            $('#products-datatable_length').addClass('col-lg-6 col-md-6 col-sm-6');
            $('#products-datatable_length .form-control').addClass('m-bootstrap-select m-bootstrap-select--air filter-select');
            $('#date-filter').addClass('col-lg-3 col-md-3 col-sm-3');
            $('#products-datatable_filter').addClass('col-lg-3 col-md-3 col-sm-3');
            ...
            $('#products-datatable_filter label:first-child input').attr('placeholder', 'by Product name');

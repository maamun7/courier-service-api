...
@section('title') Store List @stop


@section('page_name')
     Store  Management
    <small>All Store </small>
@stop

@section ('breadcrumbs')
    <li> <a href="{!! route('admin.dashboard') !!}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
    <li class="active"> {!! link_to_route('admin.stores', ' Store Management') !!} </li>
@stop
...
@section('content')
        ...
        <div class="m-portlet__body">
            <div class="m-section">
                <div class="m-section__content">
                    <table id="Stores-datatable" class="table table-sm m-table m-table--head-bg-brand table-responsive table-striped table-hover custom_table_responsive">
                        <thead class="">
                        <tr>
                            <th>Sl.</th>
                            <th>Store Name</th>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var table = $('#Stores-datatable').DataTable({
                processing: true,
                serverSide: true,
                paging: true,
                pageLength: 25,
                ...
                ajax: {
                    url: '{!! route('admin.datatable.store') !!}',
                    type: 'GET',
                    data: function( d ) {
                        d._token = "{{ csrf_token() }}";
                    }
            ...
            $('#Stores-datatable_length').addClass('col-lg-6 col-md-6 col-sm-6');
            $('#Stores-datatable_length .form-control').addClass('m-bootstrap-select m-bootstrap-select--air filter-select');
            $('#date-filter').addClass('col-lg-3 col-md-3 col-sm-3');
            $('#Stores-datatable_filter').addClass('col-lg-3 col-md-3 col-sm-3');
            ...
            $('#Stores-datatable_filter label:first-child input').attr('placeholder', 'by store name');

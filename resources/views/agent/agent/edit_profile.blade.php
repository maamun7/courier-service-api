...
@section ('breadcrumbs')
    ...
    <li class="active"> {!! link_to_route('agent.user_profile', 'Profile Management') !!} </li>
...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        {!! Form::open(['route' => ['agent.update_profile'], 'role' => 'form', 'method' => 'post', 'id' => "edit-user-profile", 'files'=>true]) !!}
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-2">
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('first_name') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('first_name', $user->first_name, ['class' => 'form-control m-input', 'id'=>'first_name','value'=>Input::old('first_name'), 'placeholder' => 'Enter first name',  'tabindex' => '1']) !!}
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('last_name') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('last_name', $user->last_name, ['class' => 'form-control m-input', 'id'=>'pk_unit_fare','value'=>Input::old('last_name'), 'placeholder' => 'Enter last name',  'tabindex' => '2']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12{!! $errors->has('email') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('email', $user->email, ['class' => 'form-control m-input', 'id'=>'email','value'=>Input::old('email'), 'placeholder' => 'Enter email',  'tabindex' => '3']) !!}
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('mobile_no') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('mobile_no', $user->mobile_no, ['class' => 'form-control m-input', 'id'=>'mobile_no','value'=>Input::old('mobile_no'), 'placeholder' => 'Enter mobile_no',  'tabindex' => '4']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('gender') ? 'has-error' : ''  !!} ">
                                ...
                                {!! Form::select('gender', ['1' => 'Male', '0' => 'Female'], $user->gender, array('class' => 'form-control m-input m-bootstrap-select m-bootstrap-select--air m_selectpicker1', 'value'=>Input::old('gender'), 'tabindex' => '5')) !!}
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('username', $user->username, ['class' => 'form-control m-input', 'id'=>'email','value'=>Input::old('username'), 'placeholder' => 'Enter username',  'tabindex' => '6']) !!}
                        ...
                        <div class="form-group m-form__group row">                     
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('profile_pic') ? 'has-error' : ''  !!} ">
                                <label>Picture</label>
                                {!! Form::file('profile_pic', null, ['class' => 'form-control m-input','id'=>'profile_pic', 'tabindex' => '7']) !!}

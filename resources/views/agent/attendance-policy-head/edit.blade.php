...
@section('title') Edit Attendance Policy Head @stop


@section('page_name')
    Attendance Policy Head Management
    <small>Edit Attendance Policy Head</small>
@stop
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                        Edit Attendance Policy Head
                    </h3>
                </div>
            </div>
        </div>
        <!--begin::Form-->
        {!! Form::open(['route' => 'attendance.policy.head.update', 'role' => 'form', 'method' => 'post', 'id' => "add-attendancePolicyHead","enctype"=>"multipart/form-data"]) !!}
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('name') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('name', !empty($formData) ? $formData->name : '', ['class' => 'form-control m-input','id'=>'name','value'=>Input::old('name'), 'placeholder' => 'Enter policy head name', 'tabindex' => '1']) !!}
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('effective_from') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('effective_from', !empty($formData) ? $formData->effective_from : '', ['class' => 'form-control m-input form_datetime','id'=>'effective_from','value'=>Input::old('name'), 'placeholder' => 'Enter effective date & time','readonly', 'tabindex' => '1']) !!}

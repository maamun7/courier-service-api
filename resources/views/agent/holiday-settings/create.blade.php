...
@section ('breadcrumbs')
    ...
    <li class="active"> {!! link_to_route('agent.holiday_settings.create', 'New Holidays') !!} </li>
@stop
...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        {!! Form::open(['route' => 'agent.holiday-settings.store', 'role' => 'form', 'method' => 'post', 'id' => 'add-holiday_settings']) !!}
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-2">
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('title') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('title', null, ['class' => 'form-control m-input','id'=>'title','value'=>Input::old('title'), 'placeholder' => 'Enter title', 'tabindex' => '1']) !!}
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('description') ? 'has-error' : '' !!}">
                                ...
                                {!! Form::text('description', null, ['class' => 'form-control m-input', 'id'=>'description','value'=>Input::old('description'), 'placeholder' => 'Enter description', 'tabindex' => '2']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('from_date') ? 'has-error' : '' !!}">
                                ...
                                <div class='input-group date' id='m_datepicker1'>
                                    {!! Form::text('from_date', null, ['class' => 'form-control m-input', 'id'=>'from_date','value'=>Input::old('from_date'), 'readonly', 'placeholder' => 'Select date', 'tabindex' => '2']) !!}
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 {!! $errors->has('to_date') ? 'has-error' : '' !!}">
                                ...
                                <div class='input-group date' id='m_datepicker2'>
                                    {!! Form::text('to_date', null, ['class' => 'form-control m-input', 'id'=>'to_date','value'=>Input::old('to_date'), 'readonly', 'placeholder' => 'Select date', 'tabindex' => '2']) !!}
                                    <span class="input-group-addon">
                                        <i class="la la-calendar-check-o"></i>
                                    </span>
                                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(".reset-form").click(function() {
                $(':input','#add-holiday_settings').not(':button, :submit, :reset, :hidden').val('').removeAttr('checked').removeAttr('selected');
            })
        });
    </script>
@stop
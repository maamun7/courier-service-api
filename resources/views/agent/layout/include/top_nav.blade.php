						...
						<div class="m-dropdown__inner">
							<div class="m-dropdown__header m--align-center" style="background: url('/backend/ezzyr_assets/app/media/img/misc/notification_bg.jpg'); background-size: cover;">
								<span class="m-dropdown__header-title">
									@if(count($notifications)) <span class="label label-danger">{!! count($notifications) !!} </span> @endif
								</span>
						...
						<div class="m-dropdown__inner">
							<div class="m-dropdown__header m--align-center" style="background: url('/backend/ezzyr_assets/app/media/img/misc/user_profile_bg.jpg'); background-size: cover;">
								<div class="m-card-user m-card-user--skin-dark">
									...
									@if(get_user_profile_pic() != '')
										<img src="{{ url('/resources/profile_pic') }}/{{ get_user_profile_pic() }}" class="m--img-rounded m--marginless" alt=""/>
									@else
										<img src="{{ url('backend/dist/img/avatar.png') }}" class="m--img-rounded m--marginless">
									@endif
									</div>
								...
								<div class="m-dropdown__content">
									<ul class="m-nav m-nav--skin-light">
										...
										<li class="m-nav__item">
											<a href="{{ url('/admin/change-password') }}" class="m-nav__link">
										...
										<li class="m-nav__item">
											<a href="{{ url('/admin/user-profile') }}" class="m-nav__link">

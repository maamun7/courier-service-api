...
@section('page_name')
    ...
    <small>New Outlet Category</small>
@stop
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                        Add New Outlet Category
                    </h3>
                </div>
            </div>
        </div>
        <!--begin::Form-->
        {!! Form::open(['route' => 'outlet.category.store', 'role' => 'form', 'method' => 'post', 'id' => "add-outlet","enctype"=>"multipart/form-data"]) !!}
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group m-form__group row">
                            {{--<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('status') ? 'has-error' : '' !!}">--}}
                                ...
                                {{--{!! Form::select('status', [1=>"active",0=>"inactive"],1, ['class' => 'form-control m-input', 'id'=>'status','value'=>Input::old('status'), 'placeholder' => 'Select status', 'tabindex' => '2']) !!}--}}
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(".reset-form").click(function() {
                $(':input','#add-outlet').not(':button, :submit, :reset, :hidden').val('').removeAttr('checked').removeAttr('selected');
            })
        });

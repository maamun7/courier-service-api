...
@section('title') Outlet Category List @stop


@section('page_name')
    Outlet Category Management
    <small>All Outlet Category List</small>
@stop

@section ('breadcrumbs')
    <li> <a href="{!! route('admin.dashboard') !!}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
    <li class="active"> {!! link_to_route('outlet.category', 'Category Management') !!} </li>
@stop
...
@section('content')
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        <a href="{!! route('outlet.category.create') !!}" class="btn btn-sm btn-brand m-btn--pill">
                            <span class="la la-plus"></span>&nbsp; New Category
                        </a>
                    </h3>
                </div>
            </div>
        ...
        <div class="m-portlet__body">
            <div class="m-section">
                <div class="m-section__content">
                    <table id="outlet-category-datatable" class="table table-sm m-table m-table--head-bg-brand table-responsive table-striped table-hover custom_table_responsive">
                        <thead class="">
                        <tr>
                            <th>Sl.</th>
                            <th>Category Name</th>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var table = $('#outlet-category-datatable').DataTable({
                processing: true,
                serverSide: true,
                paging: true,
                pageLength: 25,
                ...
                ajax: {
                    url: '{!! route('outlet.category.data') !!}',
                    type: 'GET',
                    data: function( d ) {
                        d._token = "{{ csrf_token() }}";
                    }
            ...
            $('#outlet-category-datatable_length').addClass('col-lg-6 col-md-6 col-sm-6');
            $('#outlet-category-datatable_length .form-control').addClass('m-bootstrap-select m-bootstrap-select--air m_selectpicker');
            $('#date-filter').addClass('col-lg-3 col-md-3 col-sm-3');
            $('#outlet-category-datatable_filter').addClass('col-lg-3 col-md-3 col-sm-3');
            ...
            $('#outlet-category-datatable_filter label:first-child input').attr('placeholder', 'Name, gorup, moto');
